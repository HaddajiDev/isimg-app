...
const _demoSeances = <Seance>[
  ...
  Seance(weekday: 1, slot: _s2, seanceIndex: 2, type: SeanceType.cours, matiere: 'Mathématiques discrètes', enseignant: 'L. Karoui', salle: 'A2'),
  Seance(weekday: 1, slot: _s4, seanceIndex: 4, type: SeanceType.tp, matiere: 'Atelier de programmation', enseignant: 'S. Trabelsi', salle: 'Lab04'),
  Seance(weekday: 1, slot: _s6, seanceIndex: 6, type: SeanceType.td, matiere: 'Logique et raisonnement', enseignant: 'N. Belhaj', salle: 'A2'),

  Seance(weekday: 2, slot: _s1, seanceIndex: 1, type: SeanceType.td, matiere: 'Expression et communication', enseignant: 'R. Slimani', salle: 'S05'),
  Seance(weekday: 2, slot: _s2, seanceIndex: 2, type: SeanceType.tp, matiere: 'Architecture des ordinateurs', enseignant: 'Y. Gharbi', salle: 'LabElec'),
  Seance(weekday: 2, slot: _s4, seanceIndex: 4, type: SeanceType.tp, matiere: 'Systèmes d\'exploitation', enseignant: 'K. Jaziri', salle: 'Lab04'),
  Seance(weekday: 2, slot: _s5, seanceIndex: 5, type: SeanceType.tp, matiere: 'Création multimédia', enseignant: 'S. Ferchichi', salle: 'Lab07'),
  Seance(weekday: 2, slot: _s6, seanceIndex: 6, type: SeanceType.tp, matiere: 'Atelier de programmation', enseignant: 'S. Trabelsi', salle: 'Lab07'),

  Seance(weekday: 3, slot: _s1, seanceIndex: 1, type: SeanceType.td, matiere: 'Architecture des ordinateurs', enseignant: 'H. Mansouri', salle: 'S09'),
  Seance(weekday: 3, slot: _s2, seanceIndex: 2, type: SeanceType.td, matiere: 'Algorithmique et structures de données', enseignant: 'A. Bouaziz', salle: 'S05'),
  Seance(weekday: 3, slot: _s4, seanceIndex: 4, type: SeanceType.cours, matiere: 'Création multimédia', enseignant: 'T. Abidi', salle: 'A2'),
  Seance(weekday: 3, slot: _s6, seanceIndex: 6, type: SeanceType.cours, matiere: 'Architecture des ordinateurs', enseignant: 'M. Chaabane', salle: 'A2'),

  Seance(weekday: 4, slot: _s1, seanceIndex: 1, type: SeanceType.td, matiere: 'Mathématiques discrètes', enseignant: 'L. Karoui', salle: 'A2'),
  Seance(weekday: 4, slot: _s2, seanceIndex: 2, type: SeanceType.cours, matiere: 'Algorithmique et structures de données', enseignant: 'B. Nasri', salle: 'A2'),

  Seance(weekday: 5, slot: _s1, seanceIndex: 1, type: SeanceType.cours, matiere: 'Logique et raisonnement', enseignant: 'I. Rekik', salle: 'A1'),
  Seance(weekday: 5, slot: _s2, seanceIndex: 2, type: SeanceType.cours, matiere: 'Analyse mathématique', enseignant: 'W. Ayari', salle: 'A5'),
  Seance(weekday: 5, slot: _s3, seanceIndex: 3, type: SeanceType.cours, matiere: 'Architecture des ordinateurs', enseignant: 'M. Chaabane', salle: 'A2'),
  Seance(weekday: 5, slot: _s4, seanceIndex: 4, type: SeanceType.td, matiere: 'Architecture des ordinateurs', enseignant: 'H. Mansouri', salle: 'S02'),
  Seance(weekday: 5, slot: _s5, seanceIndex: 5, type: SeanceType.td, matiere: 'Analyse mathématique', enseignant: 'S. Dridi', salle: 'A6'),
  Seance(weekday: 5, slot: _s6, seanceIndex: 6, type: SeanceType.cours, matiere: 'Systèmes d\'exploitation', enseignant: 'K. Jaziri', salle: 'A5'),

  Seance(weekday: 6, slot: _s2, seanceIndex: 2, type: SeanceType.cours, matiere: 'Systèmes d\'exploitation', enseignant: 'K. Jaziri', salle: 'A5'),
  Seance(weekday: 6, slot: _s3, seanceIndex: 3, type: SeanceType.td, matiere: 'Anglais technique', enseignant: 'F. Ouali', salle: 'A5'),
];
...
Absences demoAbsences() {
  // Two absences landing in the current week so the timetable flags them:
  // Monday séance 2 (Mathématiques discrètes) and Wednesday séance 2
  // (Algorithmique et structures de données).
  final now = DateTime.now();
  final monday = DateTime(now.year, now.month, now.day)
      .subtract(Duration(days: now.weekday - 1));
  String d(int addDays) {
    final day = monday.add(Duration(days: addDays));
    ...
    s1: SemestreAbsences(
      ...
      matieres: const [
        MatiereAbsence(
          ...
          taux: 8,
          parType: [TypeAbsence(type: 'Cours', nbre: 1)],
        ),
        MatiereAbsence(
        ...
        MatiereAbsence(module: 'Systèmes d\'exploitation', taux: 0, parType: [TypeAbsence(type: 'Cours', nbre: 0)]),
        MatiereAbsence(module: 'Anglais technique', taux: 0, parType: [TypeAbsence(type: 'TD', nbre: 0)]),
      ],
      entries: [
        AbsenceEntry(date: d(0), seance: '2', type: 'Cours', module: 'Mathématiques discrètes', enseignant: 'L. Karoui'),
        AbsenceEntry(date: d(2), seance: '2', type: 'TD', module: 'Algorithmique et structures de données', enseignant: 'A. Bouaziz'),
      ],
    ),
    s2: SemestreAbsences(
      semestre: 2,
